    ...
    <>
      ...
      <main className="pt-24 pb-24 min-h-screen bg-gray-950">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-10 text-center text-teal-300">My Projects</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-gray-900 rounded-xl shadow-lg p-8 text-left">
              ...
              <a href="#" className="inline-block bg-teal-500 text-white px-4 py-2 rounded-xl hover:bg-teal-600 transition">View Project</a>
            </div>
            <div className="bg-gray-900 rounded-xl shadow-lg p-8 text-left">
